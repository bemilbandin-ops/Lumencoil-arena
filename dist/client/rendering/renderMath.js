...
export function interpolateSnakes(prev, next, t) {
...
export function traceBody(ctx, body) {
    ctx.beginPath();
...
export function foodPalette(food) {
    if (food.kind === 2)
        return { base: "#ffb642", inner: "#ffe99a", glow: "#ffb21f" };
    if (food.kind === 1)
        return { base: "#b695ff", inner: "#f0e8ff", glow: "#b77cff" };
    const variants = [
...
export function mod(v, m) { return ((v % m) + m) % m; }
export function rand(min, max) { return min + Math.random() * (max - min); }
//# sourceMappingURL=renderMath.js.map