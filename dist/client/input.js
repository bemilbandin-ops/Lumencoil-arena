...
export class InputController {
    state = { angle: 0, boost: false, hasDirection: false, joystickAnchor: null, joystickKnob: null };
    canvas;
    emit;
    touchPointerId = null;
    mouseBoost = false;
    ...
    onPointerMove = (e) => {
        ...
        if (Math.hypot(dx, dy) < CONFIG.MOUSE_STEER_DEADZONE_PX)
            return;
        this.setDirection(Math.atan2(dy, dx), false);
    };
    onPointerUp = (e) => {
