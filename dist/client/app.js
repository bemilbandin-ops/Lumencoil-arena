...
class App extends React.Component {
    ...
    renderMenu() {
        ...
        const food = Array.from({ length: 14 }, (_, index) => h("i", {
            ...
            style: { "--food": foodColors[index % foodColors.length] }
        }));
        const segments = Array.from({ length: 12 }, (_, index) => h("i", { key: `segment-${index}`, className: "preview-segment" }));
        return h("main", { className: "launch-screen", style: stageStyle }, h("div", { className: "launch-grit", "aria-hidden": true }), h("div", { className: "launch-food-field", "aria-hidden": true }, ...food), h("header", { className: "launch-header" }, h("div", { className: "launch-brand" }, h("strong", null, "LUMENCOIL"), h("span", null, "ARENA")), h("div", { className: "launch-rules", "aria-label": "Match format" }, h("span", null, h("b", null, "75"), " SEC GROW"), h("i"), h("span", null, h("b", null, "15"), " SEC BOSS")), h("div", { className: "launch-record" }, h("span", null, "BEST LEVEL"), h("strong", null, this.state.best.toLocaleString()))), h("section", { className: "launch-core" }, h("div", { className: "launch-copy" }, h("div", { className: "launch-mode" }, "90 SECOND SURVIVAL RUN"), h("h1", { className: "launch-title" }, "GROW FAST.", h("br"), "KILL THE BOSS."), h("p", { className: "launch-subtitle" }, "Eat everything. Cut weaker coils. Reach the boss before the clock hits zero."), h("div", { className: "launch-entry" }, h("label", { className: "callsign-field" }, h("span", null, "CALLSIGN"), h("input", {
            ...
            onKeyDown: (e) => { if (e.key === "Enter")
                this.play(); }
        })), h("button", { className: "arena-enter", onClick: this.play }, h("span", null, "DROP IN"), h("small", null, "START RUN"))), h("div", { className: "launch-controls" }, h("span", null, h("b", null, "STEER"), "MOUSE / DRAG"), h("span", null, h("b", null, "BOOST"), "CLICK / SPACE"))), h("div", { className: "coil-stage", "aria-label": `${selected.name} coil preview` }, h("div", { className: "arena-ring" }, h("div", { className: "preview-coil", "aria-hidden": true }, ...segments, h("div", { className: "preview-head" }, h("i", { className: "preview-eye eye-top" }), h("i", { className: "preview-eye eye-bottom" }), h("i", { className: "preview-snout" }))), h("div", { className: "stage-pickups", "aria-hidden": true }, h("i"), h("i"), h("i"), h("i"), h("i"), h("i"))), h("div", { className: "stage-caption" }, h("div", null, h("span", null, "SELECTED COIL"), h("strong", null, selected.name.toUpperCase())), h("div", { className: "stage-level" }, h("span", null, "SPAWN"), h("strong", null, "LV 1"))))), h("footer", { className: "launch-loadout" }, h("div", { className: "loadout-heading" }, h("span", null, "CHOOSE COIL"), h("small", null, "COLOR CHANGES INSTANTLY")), h("div", { className: "loadout-skins" }, ...SKINS.map(s => h("button", {
            key: s.id,
        ...
        }, h("i", { style: { background: s.body, boxShadow: `inset -5px -5px 0 ${s.secondary}` } }), h("span", null, s.name)))), h("div", { className: "launch-settings" }, h("button", {
