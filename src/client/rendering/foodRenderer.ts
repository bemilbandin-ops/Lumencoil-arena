import type { FoodSnapshot } from "../../shared/types.js";
...
const PEARL_VARIANTS: readonly PearlVariant[] = [
...
const AMBIENT_COLORS: readonly FoodColors[] = [
...
const RARE_COLORS: readonly FoodColors[] = [
...
const DEAD_COLORS: readonly FoodColors[] = [
...
function tracePearl(ctx: CanvasRenderingContext2D, radius: number, variant: PearlVariant): void {
