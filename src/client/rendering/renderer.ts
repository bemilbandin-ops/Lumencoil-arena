...
import { clamp, type SnakeSnapshot, type Vec2, type WorldEvent } from "../../shared/types.js";
...
import type { CameraState, GroundSpeck, RenderPair, VisualEnv } from "./renderTypes.js";

export type { RenderPair } from "./renderTypes.js";
...
export class GameRenderer {
  ...
  setEffects(enabled: boolean): void { this.effects.setEnabled(enabled); }
